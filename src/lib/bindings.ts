...
export type AssetSummary = { id: string; assetType: AssetType; name: string; creator: string; category?: string | null; imageFilename: string | null; hasMemo: boolean; dependencies: string[]; boothItemId: number | null; publishedAt: number | null }
...
export type DisplayStyle = "GridSmall" | "GridMedium" | "GridLarge" | "Catalog" | "List"
